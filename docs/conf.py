...
htmlhelp_basename = "aiida-phonoxpydoc"
...
latex_documents = [
    (
        master_doc,
        "aiida-phonoxpy.tex",
        u"aiida-phonoxpy Documentation",
        u"Atsushi Togo",
        "manual",
    ),
]
...
man_pages = [
    (master_doc, "aiida-phonoxpy", u"aiida-phonoxpy Documentation", [author], 1)
]
